...
import numpy as np
#User interface
def change_dress(event,x,y,flags,param):
    global ih,i
    if event==cv2.EVENT_LBUTTONUP:
        ...
        if i==3:
            i=1
#Display shirt to user
shirts=[cv2.imread("C:\Users\Sai\code\shirt1.png",-1),cv2.imread("C:\Users\Sai\code\shirt2.png",-1),cv2.imread("C:\Users\Sai\code\shirt51.jpg",-1),cv2.imread("C:\Users\Sai\code\shirt6.png",-1)]
for a in range(1,5):
    cv2.imshow('shirt'+str(a),shirts[a-1])
cv2.waitKey(1)
pants=[cv2.imread("C:\Users\Sai\code\pant7.jpg",-1),cv2.imread("C:\Users\Sai\code\pant21.png",-1)]
for b in range(1,3):
    cv2.imshow('pant'+str(b),pants[b-1])
...
print "-Left click to change shirt"
print "-Right click to change pant"
print "-Press 'q' to exit"
while True:        
    imgarr=["C:\Users\Sai\code\shirt1.png",'C:\Users\Sai\code\shirt2.png','C:\Users\Sai\code\shirt51.jpg','C:\Users\Sai\code\shirt6.png']
    ...
    imgarr=["C:\Users\Sai\code\pant7.jpg",'C:\Users\Sai\code\pant21.png']
    #i=input("Enter the pant number you want to try")
    ...
    face_cascade=cv2.CascadeClassifier('C:\Users\Sai\Desktop\haarcascade_frontalface_default.xml') 
    ...
    cv2.resizeWindow("img", width*3/2, height*3/2)
